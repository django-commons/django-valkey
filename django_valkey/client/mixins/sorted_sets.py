...
from django_valkey.client.mixins.protocols import ClientProtocol


class SortedSetMixin(ClientProtocol):
    """Mixin providing Valkey sorted set (ZSET) operations."""
    ...
    def zcount(
        self,
        name: KeyT,
        min: Union[float, str],  # noqa: A002
        max: Union[float, str],  # noqa: A002
        version: Optional[int] = None,
        client: Optional[Valkey] = None,
    ) -> int:
