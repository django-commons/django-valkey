...
class TestDjangoValkeyCache:
    ...
    def test_zadd_with_nx(self, cache: ValkeyCache):
    ...
    def test_zadd_with_xx(self, cache: ValkeyCache):
    ...
    def test_zadd_with_ch(self, cache: ValkeyCache):
    ...
    def test_zcard(self, cache: ValkeyCache):
    ...
    def test_zcount(self, cache: ValkeyCache):
    ...
    def test_zincrby(self, cache: ValkeyCache):
    ...
    def test_zpopmax(self, cache: ValkeyCache):
    ...
    def test_zpopmin(self, cache: ValkeyCache):
    ...
    def test_zrange_basic(self, cache: ValkeyCache):
    ...
    def test_zrange_withscores(self, cache: ValkeyCache):
    ...
    def test_zrange_desc(self, cache: ValkeyCache):
        """Test zrange in descending order."""
        cache.zadd("scores", {"a": 1.0, "b": 2.0, "c": 3.0})
        result = cache.zrange("scores", 0, -1, desc=True)
        assert result == ["c", "b", "a"]

    def test_zrangebyscore(self, cache: ValkeyCache):
    ...
    def test_zrangebyscore_withscores(self, cache: ValkeyCache):
        """Test zrangebyscore with scores."""
        cache.zadd("scores", {"a": 1.0, "b": 2.0, "c": 3.0})
        result = cache.zrangebyscore("scores", 1.0, 2.0, withscores=True)
        assert result == [("a", 1.0), ("b", 2.0)]

    def test_zrangebyscore_pagination(self, cache: ValkeyCache):
    ...
    def test_zrank(self, cache: ValkeyCache):
    ...
    def test_zrem(self, cache: ValkeyCache):
    ...
    def test_zremrangebyscore(self, cache: ValkeyCache):
    ...
    def test_sorted_set_serialization(self, cache: ValkeyCache):
    ...
    def test_sorted_set_version_support(self, cache: ValkeyCache):
    ...
    def test_sorted_set_float_scores(self, cache: ValkeyCache):
    ...
    def test_sorted_set_negative_scores(self, cache: ValkeyCache):
    ...
    def test_zpopmin_empty_set(self, cache: ValkeyCache):
    ...
    def test_zpopmax_empty_set(self, cache: ValkeyCache):
